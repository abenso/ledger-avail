...
| Name            | Nano S | Nano S XL | Nano SP/X - Stax | Nesting | Arguments                                                                                      |
| --------------- | ------ | --------- | ---------------- | ------- | ---------------------------------------------------------------------------------------------- |
| Dispatch        |        |           |                  |         | `Compactu32`destination_domain<br/>`H256`recipient_address<br/>`BoundedVecu8`message_body<br/> |
| Update          |        |           |                  |         | `SignedUpdate`signed_update<br/>`Compactu32`max_index<br/>                                     |
| Improper update |        |           |                  |         | `SignedUpdate`signed_update<br/>                                                               |
| Set updater     |        |           |                  |         | `H160`new_updater<br/>                                                                         |

## NomadDABridge

| Name                   | Nano S | Nano S XL | Nano SP/X - Stax | Nesting | Arguments                                                                               |
| ---------------------- | ------ | --------- | ---------------- | ------- | --------------------------------------------------------------------------------------- |
| Try dispatch data root |        |           |                  |         | `Compactu32`destination_domain<br/>`H256`recipient_address<br/>`BoxDaHeader`header<br/> |
...
| Name                    | Nano S | Nano S XL | Nano SP/X - Stax | Nesting | Arguments                                                                                                                                     |
| ----------------------- | ------ | --------- | ---------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Fulfill call            |        |           |                  |         | `H256`function_id<br/>`FunctionInput`input<br/>`FunctionOutput`output<br/>`FunctionProof`proof<br/>`u64`slot<br/>                             |
| Execute                 |        |           |                  |         | `u64`slot<br/>`Message`message<br/>`ValidProof`account_proof<br/>`ValidProof`storage_proof<br/>                                               |
| Source chain froze      |        |           |                  |         | `u32`source_chain_id<br/>`bool`frozen<br/>                                                                                                    |
| Send message            |        |           |                  |         | `MessageType`message_type<br/>`H256`to<br/>`Compactu32`domain<br/>`Optionu128`value<br/>`OptionH256`asset_id<br/>`OptionBoundedData`data<br/> |
| Set poseidon hash       |        |           |                  |         | `u64`period<br/>`BoundedVecu8`poseidon_hash<br/>                                                                                              |
| Set broadcaster         |        |           |                  |         | `u32`broadcaster_domain<br/>`H256`broadcaster<br/>                                                                                            |
