...
const expected_address = '5H1SznGrWNBoW4v3Z9D4A8Nv1uFbBmZnafXcAnFzjd8ocNst'
const expected_pk = 'dab1684bba3435f066640c8e5be4f7c8a7c65f6a307338b2d96102fd2179f4f9'
...
describe('Standard', function () {
  ...
  test.concurrent.each(models)('get app version', async function (m) {
    ...
    try {
      await sim.start({ ...defaultOptions, model: m.name })
      const app = newSubstrateApp(sim.getTransport(), 'Avail')
